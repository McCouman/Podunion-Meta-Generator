...
?>
	<label>Zeitangabe</label>
		<p>
			<?php $mb->the_field('highlights_jorg_time'); ?>
			<input placeholder="00:00.000" type="text" style="width:13%;" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
		</p>

<center>
	<p><a href="#" class="docopy-highlights_jorg button">Jörgs Highlights Erstellen</a></p>
</center>
	
	<?php while($mb->have_fields_and_multi('highlights_jorg')): ?>
	...
	<div style="background: #eee; border-left: 2px solid #cb0; padding: 15px; margin-top: 12px;">
		...
		<p>
			<?php $mb->the_field('highlights_jorg_name'); ?>
		...
		<p>
			<?php $mb->the_field('highlights_jorg_image'); ?>
...
<div style="width:100%; height: 80px;">
	<div style="width: 40%; float:left;">	
			<?php $mb->the_field('highlights_jorg_text_eins'); ?>
			<input placeholder="Linkname" type="text" style="width:100%;" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
	</div>	
	<div style="width: 60%; float:left;">
			<?php $mb->the_field('highlights_jorg_link_eins'); ?>
			<input placeholder="http://podcastname.tld" type="text" style="width:100%;" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
	</div>
<div style="clear:both;"></div>
	<div style="width: 40%; float:left;">	
			<?php $mb->the_field('highlights_jorg_text_zwei'); ?>
			<input placeholder="Linkname" type="text" style="width:100%;" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
	</div>	
	<div style="width: 60%; float:left;">
			<?php $mb->the_field('highlights_jorg_link_zwei'); ?>
			<input placeholder="http://podcastname.tld" type="text" style="width:100%;" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
	</div>
<div style="clear:both;"></div>
	<div style="width: 40%; float:left;">	
			<?php $mb->the_field('highlights_jorg_text_drei'); ?>
			<input placeholder="Linkname" type="text" style="width:100%;" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
	</div>	
	<div style="width: 60%; float:left;">
			<?php $mb->the_field('highlights_jorg_link_drei'); ?>
			<input placeholder="http://podcastname.tld" type="text" style="width:100%;" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
	</div>
</div>	
